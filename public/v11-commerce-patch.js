(function cardcraftV11CommercePatch(){
  ...
  function loadV12(){
    if(!document.querySelector('link[data-cardcraft-v12]')){
      const link=document.createElement('link');link.rel='stylesheet';link.href='./v12.css?v=12.0';link.dataset.cardcraftV12='1';document.head.appendChild(link);
    }
    if(!document.querySelector('script[data-cardcraft-v12]')){
      const script=document.createElement('script');script.src='./v12.js?v=12.0';script.dataset.cardcraftV12='1';document.body.appendChild(script);
    }
  }
  function install(){
    ...
    if(!document.getElementById('ccSourceChoice')){
